 ...
 * @method static void renderUserPermissionsMenuItem() Render 'User Permissions' menu item.
 * @method static void renderUserPermissionsTab() Render 'User Permissions' tab.
 */
