...
class Menu extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_menu',
			[
				'label'         => esc_html__( 'Menu', 'zeus-elementor' ),
			]
		);
		...
		if ( ! empty( $menus ) ) {
			...
			$this->add_control(
				...
				[
					...
					'raw'           => '<strong>' . esc_html__( 'There are no menus in your site.', 'zeus-elementor' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'zeus-elementor' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator'     => 'after',
		...
		$this->add_control(
			'schema',
			[
				'label'         => esc_html__( 'Add Schema Markup', 'zeus-elementor' ),
				'description'   => esc_html__( 'Schema Markup helps search engines better understand your content, recommended to enable it.', 'zeus-elementor' ),
		...
		$this->add_control(
			'layout',
			[
				'label'         => esc_html__( 'Layout', 'zeus-elementor' ),
				'type'          => Controls_Manager::SELECT,
				'default'       => 'horizontal',
				'options'       => [
					'horizontal' => esc_html__( 'Horizontal', 'zeus-elementor' ),
					'vertical' => esc_html__( 'Vertical', 'zeus-elementor' ),
					'dropdown' => esc_html__( 'Dropdown', 'zeus-elementor' ),
				],
		...
		$this->add_control(
			'align_items',
			[
				'label'         => esc_html__( 'Align', 'zeus-elementor' ),
				...
				'options'       => [
					...
					'justify' => [
						'title' => esc_html__( 'Stretch', 'zeus-elementor' ),
		...
		$this->add_control(
			'submenu_icon',
			[
				'label'         => esc_html__( 'Submenu Indicator', 'zeus-elementor' ),
		...
		$this->add_control(
			'heading_search_icon',
			[
				'label'         => esc_html__( 'Search Icon', 'zeus-elementor' ),
		...
		$this->add_control(
			'search_icon',
			[
				'label'         => esc_html__( 'Add Search Icon', 'zeus-elementor' ),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
			]
		);
		...
		$this->add_control(
			'search_post_types',
			array(
				'label'     => esc_html__( 'Search Source', 'zeus-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '0',
		...
		$this->add_control(
			'search_placeholder',
			[
				'label'         => esc_html__( 'Search Placeholder', 'zeus-elementor' ),
				'type'          => Controls_Manager::TEXT,
				'dynamic'       => [
					'active' => true,
				],
				'label_block'   => false,
				'default'       => esc_html__( 'Search', 'zeus-elementor' ),
				'condition'     => [
					'search_icon' => 'yes',
				],
			]
		...
		if ( is_woocommerce_active() ) {
			$this->add_control(
				'heading_cart_icon',
				[
					'label'         => esc_html__( 'Cart Icon', 'zeus-elementor' ),
					'type'          => Controls_Manager::HEADING,
					'separator'     => 'before',
				]
			);
			...
			$this->add_control(
				'cart_icon',
				[
					'label'         => esc_html__( 'Add Cart Icon', 'zeus-elementor' ),
					'type'          => Controls_Manager::SWITCHER,
					'default'       => 'yes',
				]
			);
			...
			$this->add_control(
				'hide_cart_icon',
				[
					'label'         => esc_html__( 'Show Only On Dropdown', 'zeus-elementor' ),
					'type'          => Controls_Manager::SWITCHER,
					'default'       => 'no',
					'condition'     => [
						'cart_icon' => 'yes',
			...
			$this->add_control(
				'cart_dropdown_text',
				[
					'label'         => esc_html__( 'Cart Dropdown Text', 'zeus-elementor' ),
					'type'          => Controls_Manager::TEXT,
					'dynamic'       => [
						'active' => true,
					],
					'label_block'   => false,
					'default'       => esc_html__( 'Your Cart', 'zeus-elementor' ),
					'condition'     => [
						'cart_icon' => 'yes',
					],
				]
		...
		$this->add_control(
			...
			[
				'label'         => esc_html__( 'Mobile Dropdown', 'zeus-elementor' ),
				'type'          => Controls_Manager::HEADING,
				'separator'     => 'before',
				'condition'     => [
					'layout!' => 'dropdown',
		...
		$this->add_control(
			'dropdown',
			[
				'label'         => esc_html__( 'Breakpoint', 'zeus-elementor' ),
				'type'          => Controls_Manager::SELECT,
				'default'       => 'tablet',
				'options'       => [
					'none' => esc_html__( 'None', 'zeus-elementor' ),
					'tablet' => esc_html__( 'Tablet (< 1024px)', 'zeus-elementor' ),
					'mobile' => esc_html__( 'Mobile (< 767px)', 'zeus-elementor' ),
				],
				'condition'     => [
					'layout!' => 'dropdown',
				],
		...
		$this->add_control(
			'toggle_align',
			[
				'label'         => esc_html__( 'Toggle Align', 'zeus-elementor' ),
				'type'          => Controls_Manager::CHOOSE,
				'default'       => 'center',
				'options'       => [
					'left' => [
		...
		$this->add_control(
			'dropdown_full_width',
			[
				'label'         => esc_html__( 'Dropdown Full Width', 'zeus-elementor' ),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'yes',
		...
		$this->add_responsive_control(
			'dropdown_offset',
			[
				'label'         => esc_html__( 'Dropdown Offset', 'zeus-elementor' ),
		...
		$this->add_control(
			'is_sticky',
			[
				'label'         => esc_html__( 'Add Sticky', 'zeus-elementor' ),
				'description'   => esc_html__( 'Doesn&#039;t work on Elementor Editor to avoid conflicts.', 'zeus-elementor' ),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'no',
				'frontend_available' => true,
				'separator'     => 'before',
		...
		$this->add_control(
			'has_shadow',
			[
				'label'         => esc_html__( 'Add Shadow On Sticky', 'zeus-elementor' ),
				'type'          => Controls_Manager::SWITCHER,
				'default'       => 'no',
				'condition'     => [
					'is_sticky' => 'yes',
		...
		$this->add_control(
			'sticky_breakpoint',
			[
				'label'         => esc_html__( 'Sticky Breakpoint', 'zeus-elementor' ),
				'type'          => Controls_Manager::SELECT,
				'default'       => 'none',
				'options'       => [
					'none' => esc_html__( 'Stick On All Devices', 'zeus-elementor' ),
					'1024' => esc_html__( 'Tablet (< 1024px)', 'zeus-elementor' ),
					'767' => esc_html__( 'Mobile (< 767px)', 'zeus-elementor' ),
				],
				'condition'     => [
					'is_sticky' => 'yes',
				],
		...
		$this->start_controls_section(
			'section_style_menu',
			[
				'label'         => esc_html__( 'Main Menu', 'zeus-elementor' ),
		...
		$this->start_controls_tab(
			'tab_links_active',
			[
				'label'         => esc_html__( 'Active', 'zeus-elementor' ),
			]
		);
		...
		$this->add_responsive_control(
			'search_cart_size',
			[
				'label'         => esc_html__( 'Search/Cart Icons Size', 'zeus-elementor' ),
				'type'          => Controls_Manager::SLIDER,
				'range'         => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label'         => esc_html__( 'Vertical Padding', 'zeus-elementor' ),
				'type'          => Controls_Manager::SLIDER,
				'range'         => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			'menu_space_between',
			[
				'label'         => esc_html__( 'Space Between', 'zeus-elementor' ),
				'type'          => Controls_Manager::SLIDER,
				'range'         => [
					'px' => [
						'max' => 100,
		...
		$this->start_controls_section(
			...
			[
				'label'         => esc_html__( 'Dropdown', 'zeus-elementor' ),
				'tab'           => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'raw'           => esc_html__( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'zeus-elementor' ),
				'type'          => Controls_Manager::RAW_HTML,
		...
		$this->add_control(
			...
			[
				'label'         => esc_html__( 'Divider', 'zeus-elementor' ),
				'type'          => Controls_Manager::HEADING,
				'separator'     => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'         => esc_html__( 'Toggle Button', 'zeus-elementor' ),
				'tab'           => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'         => esc_html__( 'On Sticky Navigation', 'zeus-elementor' ),
				'tab'           => Controls_Manager::TAB_STYLE,
				'condition'     => [
					'is_sticky' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				'label'         => esc_html__( 'On Sticky Nav', 'zeus-elementor' ),
				'type'          => Controls_Manager::HEADING,
				'separator'     => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'         => esc_html__( 'On Sticky Toggle Button', 'zeus-elementor' ),
				'type'          => Controls_Manager::HEADING,
				'separator'     => 'before',
			]
		);
	...
	protected function render() {
		...
		if ( 'none' !== $settings['dropdown'] ) {
			$this->add_render_attribute( 'menu-wrapper', 'class', 'zeus-menu-dropdown-' . $settings['dropdown'] );
		}
		...
		$this->add_render_attribute( 'menu-toggle', [
			...
			'role' => 'button',
			'tabindex' => '0',
			'aria-label' => esc_html__( 'Menu Toggle', 'zeus-elementor' ),
			'aria-expanded' => 'false',
		] );
